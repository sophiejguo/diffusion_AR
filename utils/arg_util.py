...
class Args(Tap):
    data_path: str = '/om/user/sophiejg/project/diffVAR/mit6.S982/projects/diffusion_AR/cifar10_imagenet_format/'
    exp_name: str = 'text'
